...
contract StarNotary is ERC721('AlpidarStarNotary','ASN') {
    ...
    //implemented via ERC721 constructor
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOf(_tokenId1) || msg.sender == ownerOf(_tokenId1));
